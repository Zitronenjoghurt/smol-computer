...
#[test]
fn test_half_adder() {
    let truth_table: TruthTable<DualIO<SingleIO>, SumCarryIO<SingleIO>> =
        TruthTable::create_from_values(vec![
...
#[test]
fn test_full_adder() {
    let truth_table: TruthTable<SumCInIO<SingleIO>, SumCarryIO<SingleIO>> =
        TruthTable::create_from_values(vec![
